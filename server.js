...
setInterval(() => {
  http.get(`https://ferrari--1.glitch.me`); ///تعديل مهم حط بدل 333م البروجكت
}, 280000);
...
const admin = "=";
var owner = "667133093001560121"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("Ferrari"); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", message => {
  ...
  if (message.content === prefix + "1help") {
    ...
    message.author.sendMessage(` ✽ **__ Ferrari Premium Bot__**
**__الاوامر العامه__** 
...
client.on("message", message => {
  ...
  if (message.content === prefix + "2help") {
    ...
    message.author.sendMessage(` **✽ Ferrari Premium Bot**
  ...
  if (message.content.startsWith(prefix + "color")) {
    if (!message.channel.guild)
      return message.channel
        ...
        .then(m => m.delete(5000));
    message.channel.sendFile(`https://cdn.discordapp.com/attachments/757727871346409542/768400088753111040/2.png`).then(msg => {
      msg.react("🖤").then(r => {
        msg.react("❤").then(r => {
          msg.react("💛").then(r => {
            msg.react("💚").then(r => {
